    ...
    , Loop = Some
      ...
      , { ID = "N1Loop2"
        , Loop = Some
          ...
          , { ID = "EMSLoop1"
            , Loop = Some
              [ { ID = "EMS", Max = None Natural, Min = None Natural }
              , { ID = "DTP", Max = Some 2, Min = Some 0 }
    ...
    , Loop = Some
      ...
      , { ID = "SESLoop1"
        , Loop = Some
          ...
          , { ID = "CRSLoop1"
            , Loop = Some
              [ { ID = "CRS", Max = None Natural, Min = None Natural }
        ...
        , Loop = Some
          ...
          , { ID = "DEGLoop1"
            , Loop = Some
              ...
              , { ID = "FOS", Max = Some 30, Min = Some 0 }
              , { ID = "NTE", Max = Some 30, Min = Some 0 }
              ]
            , Max = Some 10
            , Min = Some 0
            }
