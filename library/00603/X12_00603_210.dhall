...
, TransactionSet =
  ...
  , { ID = "L11"
    ...
    , Max = Some (< Natural : Natural | Text : Text >.Natural 300)
    , Min = Some 0
    }
  , { ID = "G62"
    , Loop =
    ...
    , Loop = Some
      ...
      , { ID = "N1Loop3"
        , Loop = Some
          ...
          , { ID = "CD3Loop1"
            , Loop = Some
              [ { ID = "CD3", Max = None Natural, Min = None Natural }
              , { ID = "L11", Max = Some 20, Min = Some 0 }
              , { ID = "H6", Max = Some 10, Min = Some 0 }
              , { ID = "L9", Max = Some 50, Min = Some 0 }
              , { ID = "POD", Max = None Natural, Min = Some 0 }
