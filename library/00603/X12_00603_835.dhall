        ...
        , Loop = Some
          ...
          , { ID = "SVCLoop1"
            , Loop = Some
              ...
              , { ID = "DTM", Max = Some 9, Min = Some 0 }
              , { ID = "CAS", Max = Some 99, Min = Some 0 }
              , { ID = "RAS", Max = Some 99, Min = Some 0 }
              , { ID = "REF", Max = Some 99, Min = Some 0 }
              , { ID = "AMT", Max = Some 20, Min = Some 0 }
              , { ID = "QTY", Max = Some 20, Min = Some 0 }
              , { ID = "LQ", Max = Some 99, Min = Some 0 }
              ]
