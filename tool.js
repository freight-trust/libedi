...
function run() {
  var helpText = "Usage: routes <libedi> <type>";
  var defaultArgs = routes_1.getDefaultArgs();
  var args = require("yargs")
    ...
    .option("defaultNumberType")
    .choices("defaultNumberType", ["number", "integer"])
    .default("defaultNumberType", defaultArgs.defaultNumberType)
    .describe("defaultNumberType", "Default number type.").argv;
  routes_1.exec(args._[0], args._[1], {
    ref: args.refs,
