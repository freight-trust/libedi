...
function (module, exports, __webpack_require__) {
  ...
  exports.StandardSegmentHeaders = [exports.ISASegmentHeader, exports.GSSegmentHeader, exports.STSegmentHeader, exports.HLSegmentHeader, exports.LSSegmentHeader, exports.LESegmentHeader];
  /***/
},
/* 2 */
...
function (module, exports, __webpack_require__) {
  ...
  class X12Segment {
    ...
    valueOf(segmentPosition, defaultValue) {
      ...
      return this.elements[index].value === undefined ? defaultValue === undefined ? null : defaultValue : this.elements[index].value;
    }
    /**
    ...
    toString(options) {
      options = options !== undefined ? X12SerializationOptions_1.defaultSerializationOptions(options) : this.options;
      let edi = this.tag;
...
function (module, exports, __webpack_require__) {
  ...
  class X12Transaction {
    ...
    setHeader(elements, options) {
      options = options !== undefined ? X12SerializationOptions_1.defaultSerializationOptions(options, false) : this.options;
...
function (module, exports, __webpack_require__) {
  ...
  const REPETITION_DELIMITER_POS = 82; // Legacy note: const INTERCHANGE_CACHE_SIZE: number = 10
  ...
  class X12Parser extends stream_1.Transform {
    ...
    _detectOptions(edi, options) {
      if (options === undefined) {
        if (this._options.canOverwrite === false) {} else {
    ...
    _parseSegments(edi, segmentTerminator, elementDelimiter) {
      ...
      for (let i = 0, l = 0, c = 0; i < edi.length; i++) {
        ...
        if (!tagged && edi[i].search(/\s/) === -1 && edi[i] !== elementDelimiter && edi[i] !== segmentTerminator) {
          ...
          currentElement.range.start = new Positioning_1.Position(l, c); // segment terminator
          ...
          const header = currentSegment.getHeader(); // is it time to manage the loop?

          const loopPathUnboundTagIndex = this.findLastIndex(loopPath, t => {
            return currentSegment.tag === t.tag && t.type === X12SegmentHeader_1.X12SegmentHeaderLoopStyle.Unbounded;
          });

          if (currentSegment.tag === currentLoopPath.tag) {
            // we are ending an unbounded loop and entering a new of the same type
            loopPath.pop(); // eslint-disable-next-line @typescript-eslint/restrict-plus-operands
            ...
            if (currentLoopPath.allowUnboundChildren === true) {
              ...
              const unboundPrevious = loopPath.pop(); // eslint-disable-next-line @typescript-eslint/restrict-plus-operands
            ...
            loopPath.push(currentLoopPath); // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
          ...
          currentSegment.loopPath = loopPath.map(lp => lp.pathTag).join('.'); // console.log(currentSegment.loopPath)
          ...
          currentElement = new X12Element_1.X12Element();
          currentElement.range.start = new Positioning_1.Position(l, c + 1); // element data
        } else {
          ...
          if (segLoopFilter !== undefined) {
            if (segLoopFilterIsRegex === true) {
              segments = txn.segments.filter(s => {
                return s.loopIndex !== undefined ? s.loopPath.match(segLoopFilter) !== null : false;
              });
            } else {
              segments = txn.segments.filter(s => {
